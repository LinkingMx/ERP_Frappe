(() => {
  ...
  var require_onscan = __commonJS({
    "node_modules/onscan.js/onscan.js"(exports, module) {
  ...
  erpnext.PointOfSale.ItemSelector = class {
    ...
    async get_parent_item_group() {
      ...
      if (r.message)
        this.item_group = this.parent_item_group = r.message;
    }
    ...
    get_item_html(item) {
      ...
      return `<div class="item-wrapper"
				...
				<div class="item-detail">
					...
					${!me.hide_images ? `<div class="item-rate">
								${format_currency(price_list_rate, item.currency, precision2) || 0} / ${uom}
							</div>` : `
							<div class="item-price">${format_currency(price_list_rate, item.currency, precision2) || 0}</div>
...
//# sourceMappingURL=point-of-sale.bundle.UGAYKEPK.js.map
