      ...
      return {
        ...
        toolbar: ((_a = this.frm) == null ? void 0 : _a.doc.docstatus) === 0 ? [
          ...
          },
          {
            ...
            click: function(node) {
              let view2 = frappe.views.trees["BOM Configurator"];
              view2.events.add_sub_assembly(node, view2, true);
            },
            condition: function(node) {
              return node.expandable;
            },
          ...
          },
          {
            ...
            click: function(node) {
              let view2 = frappe.views.trees["BOM Configurator"];
              view2.events.convert_to_sub_assembly(node, view2, true);
            },
            condition: function(node) {
              return !node.expandable;
            },
...
//# sourceMappingURL=bom_configurator.bundle.56FRRUJ5.js.map
