(() => {
  ...
  frappe.views.QueryReport = class QueryReport extends frappe.views.BaseList {
    ...
    get_report_doc() {
      return frappe.model.with_doc("Report", this.report_name).then((doc) => {
        ...
        () => this.report_doc.module && frappe.app.sidebar.show_sidebar_for_module(this.report_doc.module)
      );
    }
    get_report_settings() {
      return new Promise((resolve, reject) => {
    ...
    refresh(have_filters_changed) {
      ...
      return new Promise((resolve) => {
        ...
        const check_if_report_is_stale = () => {
          let generated_at = this.prepared_report ? this.prepared_report_document.report_end_time : this.refreshed_at;
  ...
  // frappe-html:/workspace/apps/frappe/frappe/public/js/frappe/views/reports/print_grid.html
...
`;
  ...
  // frappe-html:/workspace/apps/frappe/frappe/public/js/frappe/views/reports/print_tree.html
...
`;
  ...
  // frappe-html:/workspace/apps/frappe/frappe/public/js/frappe/ui/group_by/group_by.html
...
//# sourceMappingURL=report.bundle.5EHIA6JL.js.map
